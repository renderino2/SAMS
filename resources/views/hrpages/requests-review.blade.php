            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-4">
                    <div class="intro-y box p-5">
                        <h1 class="text-xl md:text-2xl font-medium flex items-center">
                            ...
                            Review All Student Assistant Requests
                        </h1>
                        <p class="text-slate-500 mt-2">Review and manage all student assistant requests across all offices.</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <select id="typeFilter" class="form-control">
                                    ...
                                    <option value="SA Request">SA Request</option>
                                </select>
                            </div>
                            <div>
                ...
                <div class="col-span-12 intro-y" id="requestDetailsPanel" style="display: none;">
                    <div class="box p-5">
                        ...
                        <div class="mb-4">
                            <span class="font-medium text-slate-600">Request Message:</span>
                            <div id="detailReason" class="mt-2 p-3 bg-slate-50 dark:bg-slate-800 rounded"></div>
                        </div>
                        <div class="mb-4">
                            <label for="reviewComments" class="form-label">Remarks (optional):</label>
                            <textarea id="reviewComments" class="form-control" rows="3" placeholder="Enter any remarks or notes about this request"></textarea>
                        </div>
    ...
    <script type="module">
        (function () {
            ...
            async function loadRequests() {
                try {
                    ...
                    if (!contentType || !contentType.includes('application/json')) {
                        ...
                        requestBody.innerHTML = '<tr><td colspan="9" class="text-center text-slate-500">Error loading data</td></tr>';
                        return;
                    }
            ...
            function populateOfficeFilter() {
                const offices = [...new Set(requestData.map(request => request.office).filter(Boolean))];
            ...
            function filterData() {
                ...
                filteredData = requestData.filter(request => {
                    ...
                    const matchesOffice = !selectedOffice || request.office === selectedOffice;
                    const matchesType = !selectedType || request.type === selectedType;
                    const matchesStatus = !selectedStatus || request.status === selectedStatus;

                    return matchesSearch && matchesOffice && matchesType && matchesStatus;
                });
            ...
            function getTypeBadgeClass(type) {
                switch (type) {
                    ...
                    case 'Leave Request':
                        return 'bg-success text-white whitespace-nowrap';
                    case 'Resignation':
                        return 'bg-danger text-white whitespace-nowrap';
                    case 'Overtime Request':
                        return 'bg-pending text-white whitespace-nowrap';
                    default:
                        return 'bg-cyan-900 text-white whitespace-nowrap';
                }
            }
            ...
            function getStatusBadgeClass(status) {
                switch (status) {
                    ...
                    default: return 'bg-pending text-white whitespace-nowrap';
                }
            }
            ...
            window.reviewRequest = async function(requestId) {
                ...
                document.getElementById('detailOffice').textContent = request.office || 'N/A';
